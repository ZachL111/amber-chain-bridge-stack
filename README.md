...
amber-chain-bridge-stack is a C project for blockchain tooling. It focuses on this technical goal: Implement a C blockchain tooling project for bridge graph analysis, using node-edge fixtures and cycle and reachability reports.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 158, risk penalty 4, latency penalty 2, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
